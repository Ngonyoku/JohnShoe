...
<section class="p-5">
    <div class="container-fluid" id="New Releases">
        ...
        <div class="row m-1">
            <div class="col-md-3 col-sm-10 col-5">
                <h5 class="font-weight-bold">Air Jordans</h5>
                <p><img class="img-fluid" src="Images/AirJordan2.jpg" alt="Air Jordans"></p>
                <p><b>ksh.2000</b></p>
            ...
            <div class="col-md-3 col-sm-10 col-5">
                <h5 class="font-weight-bold">Air Jordans</h5>
                <p><img class="img-fluid" src="Images/AirJordans.jpeg" alt="j's"></p>
                <p><b>ksh.2000</b></p>
                <button type="submit" class="btn btn-danger form-control" style="border-radius: 0px">Buy</button>
                <br>
                <button type="submit" class="btn btn-outline-warning form-control" style="border-radius: 0px">Add to Cart</button>
            ...
            <div class="col-md-3 col-sm-10 col-5">
                ...
                <p><img class="img-fluid" src="Images/GreenHaurache.jpg" alt="Haurache"></p>
                <p><b>ksh.2500</b></p>
                <button type="submit" class="btn btn-danger form-control" style="border-radius: 0px">Buy</button>
                <br>
                <button type="submit" class="btn btn-outline-warning form-control" style="border-radius: 0px">Add to Cart</button>
    ...
    <div class="container-fluid" id="Footer">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-5">
                ...
                <a href="#"><i class="fa fa-credit-card text-light fa-2x"> Credit card</i></a>
                <br>
                <a href="#"><i class="fab fa-cc-mastercard text-light fa-2x">Master Card</i></a>
            </div>
